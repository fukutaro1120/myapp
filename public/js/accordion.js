...
$.fn.accordion = function () {
  ...
  var timer = null; //初始化，将图片放入手风琴盒子里
  ...
  function rotation(counter) {
    ...
    self.children('li').eq(counter).nextAll().each(function (index) {
      //对当前图片的往后的所有图片进行重新定位
      $(this).stop().animate({
        left: 500 + counter * 50 + index * 50 + 'px'
      }, 700);
    });
    self.children('li').eq(counter).prevAll().each(function (index) {
      //对当前图片的往前的所有图片进行重新定位
      $(this).stop().animate({
...
/***/ 2:
/*!*****************************************!*\
  !*** multi ./resources/js/accordion.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/my_app/resources/js/accordion.js */"./resources/js/accordion.js");
